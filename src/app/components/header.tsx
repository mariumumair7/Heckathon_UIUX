...
const Header = () => {
  return (
    <div>
      ...
      <div className="relative w-full h-[120px] border-b border-white">
        <ul className="flex items-center justify-between w-full px-2 py-1">
          ...
          <li className="flex items-center">
            <Link href="/search">
              <Image src="/1.png" alt="Search" width={20} height={20} className="hover:bg-gray-200 rounded-full" />
            </Link>
          </li>
          ...
          <li className="flex items-center space-x-4">
            <Link href="/cart">
              <Image src="/cart.jpeg" alt="Cart" width={20} height={20} className="hover:bg-gray-200 rounded-full" />
            </Link>
            <Link href="/user-profile">
              <Image src="/user.jpeg" alt="User Profile" width={20} height={20} className="hover:bg-gray-200 rounded-full" />
            </Link>
          </li>
        </ul>
      </div>
      ...
      {/* Navigation Links */}
      <div className="absolute top-[90px] left-[382px] w-[675px] h-[22px] flex gap-[44px] text- medium text-DarkPrimary">
